...
MTK_PLATFORM := mt6582
MTK_PROJECT := vegetahd
TARGET_KERNEL_SOURCE := kernel/bq/vegetahd
TARGET_KERNEL_CONFIG := lineage_vegetahd_defconfig
...
TARGET_OTA_ASSERT_DEVICE := krillin,Aquaris_E45,alps,giraffe,vegetahd,Aquaris_E5_HD
